...
export const menuData: MenuCategory[] = [
    ...
    },
    {
        ...
        items: [
            { name: "Çilek", price: "₺140,00", description: "Buzlu çilek ferahlığı.", image: "/o2photos/cilekforzen.jpg" },
            ...
            { name: "Şeftali", price: "₺140,00", description: "Buzlu şeftali ferahlığı.", image: "/o2photos/seftalifrozen.jpg" },
